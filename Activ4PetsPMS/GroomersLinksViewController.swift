//
//  GroomersLinksViewController.swift
//  Activ4PetsPMS
//
...
class GroomersLinksViewController: UIViewController
{
    ...
    @IBAction func showLinksDetails(_ sender: UIButton)
    {
        ...
        if sender.tag == 1
        {
            ...
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.petgroomingfinder.com/"
                self.performSegue(withIdentifier: "GroomerLinks", sender: urlStr)
        ...
        else if sender.tag == 2
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.findagroomer.com/"
                self.performSegue(withIdentifier: "GroomerLinks", sender: urlStr)
        ...
        else if sender.tag == 3
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.groomerreview.com"
                self.performSegue(withIdentifier: "GroomerLinks", sender: urlStr)
