...
@property (nonatomic, assign) BOOL showOnFirstLaunch;//NO
@property (nonatomic, assign) BOOL groupNotesByVersion;//NO - default is also NO need to set YES for showing the sperate version number for parameter versionLabelFormat .
@property (nonatomic, assign) float checkPeriod;//ZERO-
@property (nonatomic, assign) float remindPeriod;//One Day

//message text - you may wish to customise these
@property (nonatomic, copy) NSString *inThisVersionTitle;//New Features
@property (nonatomic, copy) NSString *updateAvailableTitle;//New Version is available for A4P
@property (nonatomic, copy) NSString *versionLabelFormat;// @"Version %@"
@property (nonatomic, copy) NSString *okButtonLabel;
@property (nonatomic, copy) NSString *ignoreButtonLabel;
@property (nonatomic, copy) NSString *remindButtonLabel;//@"Remind me latter"
...
@property (nonatomic, assign) BOOL useAllAvailableLanguages;//NO
@property (nonatomic, assign) BOOL onlyPromptIfMainWindowIsAvailable;//For Mac OS only
@property (nonatomic, assign) BOOL useAppStoreDetailsIfNoPlistEntryFound;//NO
@property (nonatomic, assign) BOOL checkAtLaunch;//YES
