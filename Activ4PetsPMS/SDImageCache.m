...
- (void)storeImage:(UIImage *)image recalculateFromImage:(BOOL)recalculate imageData:(NSData *)imageData forKey:(NSString *)key toDisk:(BOOL)toDisk {
    ...
    if (toDisk) {
        dispatch_async(self.ioQueue, ^{
            ...
            if (data) {
                if (![self->fileManager fileExistsAtPath:self->_diskCachePath]) {
                    [self->fileManager createDirectoryAtPath:self->_diskCachePath withIntermediateDirectories:YES attributes:nil error:NULL];
                }
