...
- (instancetype)initWithDataPoints:(NSArray *)dataPoints {
    ...
    UIColor *fillColor = [UIColor colorWithRed:151/255.0f green:187/255.0f blue:205/255.0f alpha:0.2];
    UIColor *strokeColor = [UIColor colorWithRed:151/255.0f green:187/255.0f blue:205/255.0f alpha:0.2];
    UIColor *pointColor = [UIColor colorWithRed:151/255.0f green:187/255.0f blue:205/255.0f alpha:0.2];
