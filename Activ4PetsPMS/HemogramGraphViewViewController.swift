//
//  HemogramGraphViewViewController.swift
//  Active4PetsPMS
//
...
class HemogramGraphViewViewController: UIViewController
{
                ...
                let queryDic = json?["hemogramList"] as? [[String : Any]]
            {
                ...
                else
                {
                    ...
                    for item in filtered
                    {
                        ...
                        self.xDataList.append(hemogram.measureDate)
                        self.gramList.append(hemogram.graphValue)
                    }
