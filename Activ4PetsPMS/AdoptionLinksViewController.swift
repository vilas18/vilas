//
//  AdoptionLinksViewController.swift
//  Activ4PetsPMS
//
...
class AdoptionLinksViewController: UIViewController {
    ...
    @IBAction func showLinksDetails(_ sender: UIButton)
    {
        ...
        let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
            urlStr = "http://www.petfinder.com/"
            self.performSegue(withIdentifier: "AdoptLinks", sender: urlStr)
