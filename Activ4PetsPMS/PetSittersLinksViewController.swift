//
//  PetSittersLinksViewController.swift
//  Activ4PetsPMS
//
...
class PetSittersLinksViewController: UIViewController {
    ...
    @IBAction func showLinksDetails(_ sender: UIButton)
    {
        ...
        if sender.tag == 1
        {
            ...
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://mms.petsitters.org"
                self.performSegue(withIdentifier: "SitterLinks", sender: urlStr)
        ...
        else if sender.tag == 3
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.petsittersnetwork.com"
                self.performSegue(withIdentifier: "SitterLinks", sender: urlStr)
            })
            alertDel.addAction(cancel)
            alertDel.addAction(ok)
