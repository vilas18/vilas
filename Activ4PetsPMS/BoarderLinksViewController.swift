//
//  BoarderLinksViewController.swift
//  Activ4PetsPMS
//
...
class BoarderLinksViewController: UIViewController {
    ...
    @IBAction func showLinksDetails(_ sender: UIButton)
    {
        ...
        if sender.tag == 1
        {
            ...
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.petboardingfinder.com"
                self.performSegue(withIdentifier: "BoarderLinks", sender: urlStr)
        ...
        else if sender.tag == 4
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.findpetboarding.com"
                self.performSegue(withIdentifier: "BoarderLinks", sender: urlStr)
