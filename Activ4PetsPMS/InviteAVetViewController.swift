//
//  InviteAVetViewController.swift
//  Activ4Pets
//
//  Created by Activ Doctors Online on 10/01/18.
//  Copyright © 2018 Activ Doctors Online. All rights reserved.
//

import UIKit

class InviteAVetViewController: UIViewController {
    ...
    func webServiceToGetReferAFriend()
    {
        ...
        var urlString = String(format : "FirstName=%@&LastName=%@&Email=%@&SenderUserId=%@&Isvet=%@",self.firstName.text!,self.lastName.text!,self.email.text!,userId,"true")
