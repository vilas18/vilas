//
//  OtherLinksViewController.swift
//  Activ4PetsPMS
//
...
class OtherLinksViewController: UIViewController {
    ...
    @IBAction func showLinksDetails(_ sender: UIButton)
    {
        ...
        if sender.tag == 1
        {
            ...
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.scout.me"
                self.performSegue(withIdentifier: "OtherLinks", sender: urlStr)
        ...
        else if sender.tag == 5
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.gopetfriendly.com"
                self.performSegue(withIdentifier: "OtherLinks", sender: urlStr)
        ...
        else if sender.tag == 6
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://www.dogfriendly.com"
                self.performSegue(withIdentifier: "OtherLinks", sender: urlStr)
        ...
        else if sender.tag == 8
        {
            ...
            let cancel = UIAlertAction(title: "Cancel", style: .default, handler: nil)
            let ok = UIAlertAction(title: "I Agree", style: .default, handler:{(_ action: UIAlertAction) -> Void in
                urlStr = "http://petfriendlytravel.com"
                self.performSegue(withIdentifier: "OtherLinks", sender: urlStr)
    ...
    @IBAction func moveToSeletecdLinksPage(_ sender: UIButton)
    {
        ...
        else if sender.tag == 6
        {
            for controller: UIViewController in (self.navigationController?.viewControllers)!
            {
                if (controller is TrainerLinksViewController)
                {
                    _ = self.navigationController?.popToViewController(controller, animated: true)
                    break
                }
