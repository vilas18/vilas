//
//  UpcomingAppointmentNotificationsViewController.h
//  Activ4Pets
//
...
@interface UpcomingAppointmentNotificationsViewController : UIViewController
...
@property(nonatomic,strong) appointmentDetailsModel *upcomingModel;
