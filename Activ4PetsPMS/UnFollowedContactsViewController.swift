//
//  UnFollowedContactsViewController.swift
//  Activ4Pets
//
...
class UnFollowedContactsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate
{
    @IBOutlet weak var unfollowListTv: UITableView!
    ...
    func getList()
    {
        ...
        let urlStr = String(format : "%@?UserId=%@", API.MyContacts.UnfollowedContacts, userId)
        ...
        let task = session.dataTask(with: request)
        {
            ...
            if let json = try? JSONSerialization.jsonObject(with: data, options: []) as? [String : Any],
                let queryDic = json?["Result"] as? [[String: Any]]
            {
                ...
                DispatchQueue.main.async
                    {
                        ...
                        else
                        {
                            ...
                            self.unfollowListTv.reloadData()
    ...
    {
        return self.contactModelList.count
    }
